    ...
    <div className="card px-4 card-side bg-base-300 shadow-xl">
      ...
      <div className="card-body">
        ...
        <div className={`card-actions justify-between items-end`}>
          ...
          <button className="btn btn-primary" onClick={()=> dispatch(addItem(item))}>Add to Cart</button>
          <div className="flex gap-4 items-center">
            ...
            {!readonly && (
              <>
                <button  onClick={()=> dispatch(addItem(item))} className="btn btn-sm md:btn-md btn-primary btn-circle">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
